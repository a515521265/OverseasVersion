...
#define CCNotice(Chinese,English) English


@class CCTouchID;
@protocol HXTouchIDDelegate <NSObject>
...
@interface HXTouchID : NSObject

@property (nonatomic, weak) id<HXTouchIDDelegate> delegate;
