...
-(instancetype)initShowSpinnerWithRelevanceView:(UIView *)view{
    ...
    if (self) {
        ...
        self.spinnerTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        
        self.spinnerTableView.layer.cornerRadius =adaptX(5);
        self.spinnerTableView.layer.masksToBounds =true;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    SpinnerCell * cell = [tableView dequeueReusableCellWithIdentifier:@"Cell"];
    if (!cell) {
        
        cell = [[SpinnerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"Cell"];
        cell.cellHeight = self.relevanceView.height;
        cell.cellW = self.relevanceView.width;
    }
//    cell.textLabel.font = kLightFont(10);
//    cell.textLabel.textColor = UIColorFromRGB(0x989299);
...
//    cell.backgroundColor = UIColorFromRGB(0xf4f4f4);
    ...
    if (self.isModelArr) {
        ...
        cell.titleText = self.modelArr[indexPath.row];
    }
    return cell;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    !_backindex ? : _backindex (indexPath);
