//
//  GovernmentIDProcessingController.m
//  OverseasVersion
//
...
@interface GovernmentIDProcessingController ()

@property (nonatomic,strong) JWScrollView * scrollView;

@end

@implementation GovernmentIDProcessingController
...
//    UIImageView * imageView= [[UIImageView alloc]initWithFrame:CGRectMake(kScreenWidth - 80 -20-10, titleLab1.y, 80, 70)];
