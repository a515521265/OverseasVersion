...
@interface ContactUsViewController ()<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
//    Message *msg = [Message messageWihtContent:@"您好，在吗？" isRight:true];
//    [self.MessageArr addObject:msg];
//
//    Message *msg1 = [Message messageWihtContent:@"在不在？" isRight:true];
//    
//    [self.MessageArr addObject:msg1];
//
//    Message *msg2 = [Message messageWihtContent:@"？？？？？？" isRight:true];
//    
//    [self.MessageArr addObject:msg2];
//
//    Message *msg3 = [Message messageWihtContent:@"44444444" isRight:YES];
//    
//    [self.MessageArr addObject:msg3];
//    
//    Message *msg4 = [Message messageWihtContent:@"55555555" isRight:NO];
//    [self.MessageArr addObject:msg4];
//    
//    Message *msg5 = [Message messageWihtContent:@"666666666666666666666666666666666" isRight:YES];
...
- (void)SendImage:(UIImage *)image {
    ...
    [self submitShareImage:image success:^(NSString *imageStr) {
       HXStrong_self
        [self showHud];
        [CommonService requestuserFeedbackaccess_token:self.defaultSetting.access_token content:imageStr isPic:1 success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)getmessageList{
    ...
    [self showHud];
    [CommonService requestgetFeedbackListaccess_token:self.defaultSetting.access_token success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)sendMessage:(NSString *)message{
    ...
    [self showHud];
    [CommonService requestuserFeedbackaccess_token:self.defaultSetting.access_token content:message isPic:0 success:^(AFHTTPRequestOperation *operation, id responseObject) {
        if ([[responseObject objectForKey:@"errorCode"] integerValue] == 0) {
