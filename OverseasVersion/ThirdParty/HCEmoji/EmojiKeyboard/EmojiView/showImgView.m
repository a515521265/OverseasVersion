...
//    [showV.imageView addGestureRecognizer:pinchRecognizer];
    //当前view添加手势。
    UITapGestureRecognizer *tapRecognizer4 = [[UITapGestureRecognizer alloc]initWithTarget:showV action:@selector(tap:)];
    tapRecognizer4.numberOfTapsRequired = 1;
    tapRecognizer4.numberOfTouchesRequired = 1;
    [showV addGestureRecognizer:tapRecognizer4];
