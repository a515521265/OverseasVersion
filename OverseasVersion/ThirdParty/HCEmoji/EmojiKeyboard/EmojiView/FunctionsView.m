...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        [cell.button setTitle:Internationalization(@"照片", @"Photo") forState:UIControlStateNormal];
        [cell.button setImage:[UIImage imageNamed:@"p"] forState:UIControlStateNormal];
    } else if (indexPath.row == 1) {
        [cell.button setTitle:Internationalization(@"相机", @"Camera") forState:UIControlStateNormal];
