 ...
 *  ImgStyle类型有:  ImgStyleWithVoice，ImgStyleWithVideo，ImgStyleWithPhoto，ImgStyleWithCamera，ImgStyleWithEmoji
 *@  存储格式： 如[NSNumber numberWithInteger:ImgStyleWithVideo]
 */
