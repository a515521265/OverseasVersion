...
+ (id ) ImageName:(NSString * )imagestring title:(NSString *) string
{
    NSTextAttachment *attachMent = [[NSTextAttachment alloc] init];
    attachMent.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@",imagestring]];
    ...
    [strM insertAttributedString:attrString atIndex:0];
    return strM;
}

+ (id ) ImageName:(NSString * )imagestring title:(NSString *) string imageSize:(CGSize)size{
    NSTextAttachment *attachMent = [[NSTextAttachment alloc] init];
    attachMent.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@",imagestring]];
    attachMent.bounds= CGRectMake(0, -1, size.width, size.height);
    NSAttributedString *attrString = [NSAttributedString attributedStringWithAttachment:attachMent];
    NSString *str = string;
    if (string.length <=0)
    {
